<x-layout>
    <div class="grid grid-cols-3 gap-4">
        <div class="...">
            ...
            <div class=" block max-w-sm p-6 bg-green-600 text-white border border-gray-200 rounded-lg shadow-xl">

                <h1 class="text-center mb-2 text-2xl font-bold tracking-tight ">Students Count</h1>
                <h2 class=" text-xl text-center font-bold">10 </h2>
            </div>

        </div>
        <div class="...">

            <div class=" block max-w-sm p-6 bg-red-600 text-white border border-gray-200 rounded-lg shadow-xl">
        ...
        <div class="...">
            ...
            <div class=" block max-w-sm p-6 bg-blue-600 text-white border border-gray-200 rounded-lg shadow-xl">
            ...
            <div class="max-w-sm w-full bg-white rounded-lg shadow-sm dark:bg-gray-800 p-4 md:p-6">
                ...
                <div class="flex justify-between mb-3">
                    <div class="flex justify-center items-center">
                        <h5 class="text-xl font-bold leading-none text-gray-900 dark:text-white pe-1">Website traffic
                        </h5>
